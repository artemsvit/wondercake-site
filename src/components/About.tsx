      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 leading-relaxed max-w-2xl mx-auto">
            Welcome to Sweetest Menu! Here you'll find a delicious collection of
            tried and tested dessert recipes. From chocolate cakes to fruity pies,
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-6 leading-relaxed">
              What started as a small blog has grown into a trusted recipe resource
              for home bakers around the world. Each recipe comes with detailed
              instructions, tips, and tricks to help you create amazing desserts
              in your own kitchen.
            </p>
            <div className="space-y-4">
              <div className="flex items-center space-x-3">
                <svg className="w-6 h-6 text-[#0abab5]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" />
                </svg>
                <span className="text-gray-600">Tested and perfected recipes</span>
              </div>
              <div className="flex items-center space-x-3">
                <svg className="w-6 h-6 text-[#0abab5]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" />
